...
export default function Hero() {
  return (
    <section className="flex flex-col max-w-[1100px] lg:min-h-[30rem] items-center lg:items-start text-center lg:text-left lg:justify-center relative pt-[100vw] lg:pt-28 pb-20">
